...
import net.klouse.kteams.command.AllyGuiCommand;

import net.klouse.kteams.command.TeamCommand;

import net.klouse.kteams.command.TeamSettingsCommand;
...
import net.klouse.kteams.listener.*;
...
public final class KTeams extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getLogger().info("KTeams v2 enabled.");
