...
import net.wobble.wteams.command.AllyGuiCommand;

import net.wobble.wteams.command.TeamCommand;

import net.wobble.wteams.command.TeamSettingsCommand;
...
import net.wobble.wteams.listener.*;
